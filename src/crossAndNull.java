...
public class crossAndNull {
       ...
       public static void main(String[] args) {
        ...
        do{
            ...
            //randomInput(field, symbol); //only computer game
            symbol  =symbol=='X' ? 'O':'X';
            chekRandomIn(field, symbol);           // game with clever computer
           symbol  =symbol=='X' ? 'O':'X';
            showfield(field);
            checkRezalt(field);
   ...
   public static void randomInput(char[][] field, char symbol) { //
    ...
    public static int chekRandomIn(char field [] [], char symbol) {
        ...
        for (int i = 0; i < field.length; i++) {
            ...
            if (field[2][2] == ' ') {
               ...
               {
              // проверка наличия 2-х Х в строке
